...
CREATE TABLE IF NOT EXISTS `wegia`.`despacho` (
  ...
  INDEX `id_memorando` (`id_memorando` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `wegia`.`anexo` (
  ...
  INDEX `id_despacho` (`id_despacho` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `wegia`.`beneficios` (
  ...
  UNIQUE INDEX `descricao_beneficios` (`descricao_beneficios` ASC) VISIBLE)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4;
...
CREATE TABLE IF NOT EXISTS `wegia`.`beneficiados` (
  ...
  INDEX `id_beneficios` (`id_beneficios` ASC) VISIBLE,
  INDEX `id_pessoa` (`id_pessoa` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `wegia`.`campo_imagem` (
  ...
  UNIQUE INDEX `nome_campo` (`nome_campo` ASC) VISIBLE)
ENGINE = InnoDB
AUTO_INCREMENT = 3
DEFAULT CHARACTER SET = utf8mb4;
...
CREATE TABLE IF NOT EXISTS `wegia`.`categoria_produto` (
  ...
  UNIQUE INDEX `descricao_categoria` (`descricao_categoria` ASC) VISIBLE)
ENGINE = InnoDB
AUTO_INCREMENT = 2
DEFAULT CHARACTER SET = utf8mb4;
...
CREATE TABLE IF NOT EXISTS `wegia`.`entrada` (
  ...
  INDEX `id_origem` (`id_origem` ASC) VISIBLE,
  INDEX `id_almoxarifado` (`id_almoxarifado` ASC) VISIBLE,
  INDEX `id_tipo` (`id_tipo` ASC) VISIBLE,
  INDEX `id_responsavel` (`id_responsavel` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `wegia`.`epi` (
  ...
  PRIMARY KEY (`id_epi`),
  UNIQUE INDEX `descricao_epi` (`descricao_epi` ASC) VISIBLE)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4;
...
CREATE TABLE IF NOT EXISTS `wegia`.`unidade` (
  ...
  UNIQUE INDEX `descricao_unidade` (`descricao_unidade` ASC) VISIBLE)
ENGINE = InnoDB
AUTO_INCREMENT = 2
DEFAULT CHARACTER SET = utf8mb4;
...
CREATE TABLE IF NOT EXISTS `wegia`.`produto` (
  ...
  INDEX `id_categoria_produto` (`id_categoria_produto` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `wegia`.`isaida` (
  ...
  INDEX `id_saida` (`id_saida` ASC) VISIBLE,
  INDEX `id_produto` (`id_produto` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `wegia`.`movimentacao_funcionario` (
  ...
  INDEX `id_situacao_funcionario` (`id_situacao_funcionario` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `wegia`.`movimentacao_interno` (
  ...
  INDEX `id_situacao_interno` (`id_situacao_interno` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `wegia`.`permissao` (
  ...
  PRIMARY KEY (`id_cargo`),
  INDEX `id_acao` (`id_acao` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `wegia`.`pessoa_epi` (
  ...
  INDEX `id_pessoa` (`id_pessoa` ASC) VISIBLE,
  INDEX `id_epi` (`id_epi` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `wegia`.`situacao` (
  ...
  UNIQUE INDEX `situacoes` (`situacoes` ASC) VISIBLE)
ENGINE = InnoDB
AUTO_INCREMENT = 5
DEFAULT CHARACTER SET = utf8mb4;
...
CREATE TABLE IF NOT EXISTS `wegia`.`tabela_imagem_campo` (
  ...
  INDEX `id_campo` (`id_campo` ASC) VISIBLE,
  INDEX `id_imagem` (`id_imagem` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `wegia`.`voluntario_judicial_cargo` (
  ...
  INDEX `id_voluntarioJ` (`id_voluntarioJ` ASC) VISIBLE,
