			...
			<section role="main" class="content-body">
                ...
                <section>
                    <div class="tab-content">
                        <h2>Manual do WeGIA: Web-gerenciador de Instituições Assistenciais</h2><br>
                        ...
                        <div class="justify-content-between" style="height: 30px;">
                            <a href="./introducao.php" type="button" class="btn btn-secondary" style="float: right;">
                                1. Introdução
