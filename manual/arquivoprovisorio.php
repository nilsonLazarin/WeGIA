...
Ao acessar os dados de um funcionário é possível fazer a edição desses dados. 
Na aba "Visão Geral" é possível editar as informações pessoais do funcionário. 
Existem algumas seções nessa aba, são elas: Informações Pessoais, Endereço, Documentação e Outros. 
...
Na aba "Benefícios" é possível adicionar e editar benefícios.
...
Na seção de benefícios é possível visualizar a lista de benefícios do funcionário. Nessa lista é exibido o nome do benefício, o status, a data de início, a data de fim e valor. Para editar um benefício basta clicar no botão verde ao seu lado, ao clicar o usuário é redirecionado para uma página onde é possível editar os dados desejados. Para editá-los basta clicar no botão "Editar" e após editar clicar no botão "salvar".
Para excluir um benefício basta clicar no botão vermelho ao lado dos dados do benefício, o benefício será excluído automaticamente. 
Na aba "EPI" é possível adicionar e editar EPI's.
...
Para adicionar um EPI é necessário selecionar o EPI e o seu status e preencher a data. Caso o EPI desejado não se encontre na listagem basta clicar no símbolo de "mais" ao seu lado e na nova caixa que será aberta escrever o nome do EPI e clicar em OK para salvá-lo.
