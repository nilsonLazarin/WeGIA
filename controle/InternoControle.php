    ...
    public function incluir(){
        ...
        try{
            ...
            if(!empty($_FILES['imgRg']['tmp_name']) && $rg!="Não informado")
				{
					$imagem=file_get_contents($_FILES['imgRg']['tmp_name']);
					$extensao=pathinfo($_FILES['imgRg']['name'],PATHINFO_EXTENSION);
					$descricao="Registro Geral";
                    $imagem64= "data:image/".$extensao.";base64,".base64_encode($imagem);
                    $documento=new Documento($idPessoa,$imagem64,$extensao,$descricao);
					$docDAO->incluir($documento);
				}
			if(!empty($_FILES['imgCpf']['tmp_name']))
				{
					$imagem=file_get_contents($_FILES['imgCpf']['tmp_name']);
			...
			if(!empty($_FILES['imgCtps']['tmp_name']))
				{
					$imagem=file_get_contents($_FILES['imgCtps']['tmp_name']);
            ...
            {
                    $imagem=file_get_contents($_FILES['imgCertidaoNascimento']['tmp_name']);
                ...
                {
                    $imagem=file_get_contents($_FILES['imgCuratela']['tmp_name']);
                ...
                {
                    $imagem=file_get_contents($_FILES['imgTituloEleitor']['tmp_name']);
                ...
                {
                    $imagem=file_get_contents($_FILES['imgCertidaoCasamento']['tmp_name']);
                ...
                {
                    $imagem=file_get_contents($_FILES['imgInss']['tmp_name']);
                ...
                {
                    $imagem=file_get_contents($_FILES['imgLoas']['tmp_name']);
                ...
                {
                    $imagem=file_get_contents($_FILES['imgBpc']['tmp_name']);
                ...
                {
                    $imagem=file_get_contents($_FILES['imgFunrural']['tmp_name']);
                ...
                {
                    $imagem=file_get_contents($_FILES['imgSaf']['tmp_name']);
                ...
                {
                    $imagem=file_get_contents($_FILES['imgSus']['tmp_name']);
