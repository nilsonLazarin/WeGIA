...
class FuncionarioControle
{
    ...
    public function verificarHorario(){
        ...
        if((!isset($escala)) || (empty($escala))){
            $msg = "Escala do funcionario não informado. Por favor, informe umm escala!";
            header('Location: ../html/funcionario.html?msg='.$msg);
        }
        if((!isset($tipoCargaHoraria)) || (empty($tipoCargaHoraria))){
            $msg .= "Tipo da carga hor�ria do funcionario não informado. Por favor, informe um tipo!";
            header('Location: ../html/funcionario.html?msg='.$msg);
        }
        if((!isset($entrada1)) || (empty($entrada1))){
            $msg .= "Primeira entrada do funcionario não informado. Por favor, informe uma entrada!";
            header('Location: ../html/funcionario.html?msg='.$msg);
        }
        if((!isset($saida1)) || (empty($saida1))){
            $msg .= "Primeira sa�da do funcionario não informado. Por favor, informe uma sa�da!";
            header('Location: ../html/funcionario.html?msg='.$msg);
        }
        if((!isset($entrada2)) || (empty($entrada2))){
            $msg .= "Segunda entrada do funcionario não informado. Por favor, informe uma entrada!";
            header('Location: ../html/funcionario.html?msg='.$msg);
        }
        if((!isset($saida2)) || (empty($saida2))){
            $msg .= "Segunda sa�da do funcionario não informado. Por favor, informe uma sa�da!";
            header('Location: ../html/funcionario.html?msg='.$msg);
        }
