...
<head>
	...
	<title>Cadastro de Comorbidades</title>
					...
					<div class="col-md-8 col-lg-8">
						<div class="tabs">
							<ul class="nav nav-tabs tabs-primary">
								<li class="active">
									<a href="#overview" data-toggle="tab">Cadastro de Comorbidades</a>
							...
							<div class="tab-content">
								<div id="overview" class="tab-pane active">
									...
									<h5 class="obrig">Campos Obrigatórios(*)</h5>
										...
										<label class="col-md-3 control-label" for="inputSuccess">Doenças<sup class="obrig">*</sup></label>
										<div class="col-md-6">
