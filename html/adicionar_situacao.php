				...
				<header class="page-header">
					...
					<div class="right-wrapper pull-right">
						<ol class="breadcrumbs">
							...
							<li><span>Adicionar Situação</span></li>
						</ol>
					...
					<div class="col-md-8 col-lg-8" >
						<div class="tabs">
							<ul class="nav nav-tabs tabs-primary">
								<li class="active">
									<a href="#overview" data-toggle="tab">Inserir Situacao
									</a>
								</li>
							</ul>
									...
									<fieldset>
										<form method="post" id="formulario" action="../controle/control.php">
											<div class="form-group"><br>
												<label class="col-md-3 control-label">Situacao</label>
												<div class="col-md-8">
													<input type="text" class="form-control" name="situacoes" id="situacoes" required>
												</div>
											</div><br/>
											<input type="hidden" name="nomeClasse" value="SituacaoControle">
