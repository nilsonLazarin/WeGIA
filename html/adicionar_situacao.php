					...
					<div class="col-md-8 col-lg-8">
						<div class="tabs">
							<ul class="nav nav-tabs tabs-primary">
								<li class="active">
									<a href="#overview" data-toggle="tab">Cadastro de situação</a>
								</li>
							</ul>
								...
								<div id="overview" class="tab-pane active">
									<form class="form-horizontal" method="post" action="adicionarsituacao.php">
										...
										<div class="form-group">
											<label class="col-md-3 control-label" >Situação:
											</label>
											<div class="col-md-6">
												<input type="text" name="situacao" class="form-control" required><br/>
