...
// Verificar se o usuário está autenticado e se a sessão é válida
if (!isset($_SESSION['usuario']) || empty($_SESSION['id_pessoa'])) {
...
// Conectar ao banco de dados usando MySQLi com prepared statements
$conexao = new mysqli(DB_HOST, DB_USER, DB_PASSWORD, DB_NAME);
if ($conexao->connect_error) {
    die("Erro de conexão: " . $conexao->connect_error);
}

// Obter ID da pessoa da sessão
