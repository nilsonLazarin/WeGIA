...
<head>
	...
	<script src="<?php echo caminho2;?>Functions/enviar_dados.js"></script>
		...
		$.each(memorando,function(i,item){
			$("#tabela")
				.append($("<tr>")
					...
					.append($("<td>")
						.html("<a href=<?php echo caminho2;?>html/memorando/listar_despachos.php?id_memorando="+item.id_memorando+"&arq=1>"+item.titulo+"</a>")));
		});
...
<body>
	...
	<!-- end: page -->
	<!-- Vendor -->
		<script src="<?php echo $caminho;?>assets/vendor/select2/select2.js"></script>
		<script src="<?php echo $caminho;?>assets/vendor/jquery-datatables/media/js/jquery.dataTables.js"></script>
		<script src="<?php echo $caminho;?>assets/vendor/jquery-datatables/extras/TableTools/js/dataTables.tableTools.min.js"></script>
		<script src="<?php echo $caminho;?>assets/vendor/jquery-datatables-bs3/assets/js/datatables.js"></script>
		
		<!-- Theme Base, Components and Settings -->
		<script src="<?php echo $caminho;?>assets/javascripts/theme.js"></script>
		
		<!-- Theme Custom -->
		<script src="<?php echo $caminho;?>assets/javascripts/theme.custom.js"></script>
		
		<!-- Theme Initialization Files -->
		<script src="<?php echo $caminho;?>assets/javascripts/theme.init.js"></script>
		<!-- Examples -->
		<script src="<?php echo $caminho;?>assets/javascripts/tables/examples.datatables.default.js"></script>
		<script src="<?php echo $caminho;?>assets/javascripts/tables/examples.datatables.row.with.details.js"></script>
		<script src="<?php echo $caminho;?>assets/javascripts/tables/examples.datatables.tabletools.js"></script>
	</body>
</html>