...
// Consulta de funcionários com declaração preparada
...
if ($resultado->num_rows > 0) {
    ...
    // Consulta de permissões com declaração preparada
...
$id_memorando = isset($_GET['id_memorando']) ? (int)$_GET['id_memorando'] : 0;
