...
if(!isset($_SESSION['usuario'])){
    header ("Location: ".caminho2."html/index.php");
}
        ...
        $.each(memorando,function(i,item){
            $("#tabela")
                .append($("<tr id="+item.id_memorando+">")
                    ...
                    .append($("<td>")
                        .html("<a href=<?php echo caminho2;?>html/memorando/listar_despachos.php?id_memorando="+item.id_memorando+" id=memorando>"+item.titulo+"</a>"))
                    .append($("<td>")
                        .text(item.data))
                    .append($("<td id=opcoes_"+item.id_memorando+">")
                        .html("<a href=<?php echo caminho2;?>controle/control.php?nomeClasse=MemorandoControle&metodo=alterarIdStatusMemorando&id_memorando="+item.id_memorando+"&id_status_memorando=7&modulo=memorando id=naolido"+item.id_memorando+"><img src=<?php echo caminho2;?>img/nao-lido.png width=25px height=25px title='Não Lido'></a> <a href=<?php echo caminho2;?>controle/control.php?nomeClasse=MemorandoControle&metodo=alterarIdStatusMemorando&id_memorando="+item.id_memorando+"&id_status_memorando=9&modulo=memorando id=importante"+item.id_memorando+"><img src=<?php echo caminho2;?>img/importante.png width=25px height=25px title='Importante'></a> <a href=<?php echo caminho2;?>controle/control.php?nomeClasse=MemorandoControle&metodo=alterarIdStatusMemorando&id_memorando="+item.id_memorando+"&id_status_memorando=10&modulo=memorando id=pendente"+item.id_memorando+"><img src=<?php echo caminho2;?>img/pendente.png width=25px height=25px title='Pendente'></a>")));

                	if(item.id_status_memorando==9)
                	{
                		document.getElementById(item.id_memorando).style.backgroundColor = '#ffa0a0d4';
                		$("#importante"+item.id_memorando).html("<a href=<?php echo caminho2;?>controle/control.php?nomeClasse=MemorandoControle&metodo=alterarIdStatusMemorando&id_memorando="+item.id_memorando+"&id_status_memorando=1&modulo=memorando id=importante"+item.id_memorando+"><img src=<?php echo caminho2;?>img/importante.png width=25px height=25px title='Importante'></a>");
                	}

                	if(item.id_status_memorando==10)
                	{
                		document.getElementById(item.id_memorando).style.backgroundColor = "rgba(249, 255, 160, 0.9)";
                		$("#pendente"+item.id_memorando).html("<a href=<?php echo caminho2;?>controle/control.php?nomeClasse=MemorandoControle&metodo=alterarIdStatusMemorando&id_memorando="+item.id_memorando+"&id_status_memorando=1&modulo=memorando id=pendente"+item.id_memorando+"><img src=<?php echo caminho2;?>img/pendente.png width=25px height=25px title='Pendente'></a>");
                	}

                	if(item.id_status_memorando==7)
                	{
                		document.getElementById(item.id_memorando).style.backgroundColor = "rgba(195, 230, 255, 0.83)";
                		$("#naolido"+item.id_memorando).html("<a href=<?php echo caminho2;?>controle/control.php?nomeClasse=MemorandoControle&metodo=alterarIdStatusMemorando&id_memorando="+item.id_memorando+"&id_status_memorando=1&modulo=memorando class=naolido><img src='<?php echo caminho2;?>img/lido.png' width=25px height=25px title='Lido'></a>");
                	}
                	if(item.id_status_memorando==6)
                	{
                		$("#naolido"+item.id).html("<a href=<?php echo caminho2;?>controle/control.php?nomeClasse=MemorandoControle&metodo=alterarIdStatusMemorando&id_memorando="+item.id_memorando+"&id_status_memorando=7&modulo=memorando class=naolido><img src='<?php echo caminho2;?>img/nao-lido.png' width=25px height=25px title='Não lido'></a>");
                	}
                	if(item.id_pessoa==item.id_destinatario)
                	{
                		$("#opcoes_"+item.id_memorando).append("<a href=<?php echo caminho2;?>controle/control.php?nomeClasse=MemorandoControle&metodo=alterarIdStatusMemorando&id_memorando="+item.id_memorando+"&id_status_memorando=8&modulo=memorando><img src='<?php echo caminho2;?>img/arquivar.png' width=25px height=25px title='Arquivar memorando'></a>")
                	}
...
<body>
    <section class="body">
        ...
        <div class="inner-wrapper">
                ...
                <header class="page-header">
                    ...
                    <div class="right-wrapper pull-right">
                        <ol class="breadcrumbs">
                            <li>
                                <a href="<?php echo caminho2;?>home.php">
            ...
            <div class="panel-body">
                <form action="<?php echo caminho2;?>controle/control.php" method="post">
