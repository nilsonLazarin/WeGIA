                        ...
                        <div id="overview" class="tab-pane active">
                           <form class="form-horizontal" method="post" action="../controle/control.php">
                              ...
                              <fieldset>
                                 ...
                                 <div class="form-group">
                                    <label class="col-md-3 control-label" for="profileCompany">Dias trabalhados</label>
                                    <div class="col-md-2"> 
                                 ...
                                 <div class="form-group" style="margin-top: 20px;">
                                    <label class="col-md-3 control-label" for="profileCompany">Dias de folga</label>
                                    <div class="col-md-2"> 
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                       <label><input type="radio" name="vale_transporte" id="vale_transporte" value="Possui" style="margin-top: 10px; margin-left: 15px;"  onclick="return exibir_vale_transporte()" required><i class="fa fa-check" style="font-size: 20px;"></i></label>
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                       <label><input type="radio" name="cesta_basica" id="cesta_basica" value="Possui" style="margin-top: 10px; margin-left: 15px;" required><i class="fa fa-check" style="font-size: 20px;"></i></label>
