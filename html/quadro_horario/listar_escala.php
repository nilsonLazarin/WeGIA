...
<html class="fixed">
   ...
   <script>
	function clicar(id)
	{
		window.location.href = "../../controle/control.php?metodo=removerEscala&nomeClasse=QuadroHorarioControle&nextPage=../html/quadro_horario/listar_escala.php&id="+id;
	}
	$(function(){
		...
		$.each(tipo_quadro_horario,function(i,item){
			$("#tabela")
				.append($("<tr>")
					.attr("onclick", "clicar('" + item.id_escala+"')")
					.attr("class","teste")
					.append($("<td>")
						.text(item.descricao))
					.append($('<td />')
