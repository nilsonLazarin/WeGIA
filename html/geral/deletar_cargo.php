<?php
    ...
    $resultado = mysqli_query($conexao, "UPDATE `funcionario` SET `id_cargo`=2 WHERE id_cargo=$id_cargo");
    $resultado = mysqli_query($conexao, "DELETE FROM `cargo` WHERE id_cargo=$id_cargo");
