<?php
    ...
    if ($stmt) {
        ...
        mysqli_stmt_bind_param($stmt, "ssssiidi", $codigo, $data_emissao, $data_vencimento_inicial, $data_vencimento_final, $tipo_carne, $quantidade_boletos, $valor, $id_socio); // s d i são as representações dos tipos de cada campo. s: string, d: float, i: inteiro
