...
?>
    ...
    <?php require_once("./controller/import_conteudo_integracao.php"); ?>
    <?php require_once("./controller/import_modais_integracao.php"); ?>
    <?php require_once("./controller/import_scripts.php"); ?>
    <?php require_once("./controller/import_scripts_integracao.php"); ?>
</body>
</html>
