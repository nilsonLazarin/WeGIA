function preenche_dados(id)
{
    $("#preenche_bolr").html("<td><input type='text' name='minval' id='minval'value=></td><td><input type='text' name='minvalparc' id='minvalparc' value=></td><td><input type='text' name='maivalparc' id='maivalparc' value=></td><td><input type='text' name='unicdiasv' id='unicdiasv' value=></td><td><input type='text' name='mensaldiasv' id='mensaldiasv' value=></td><td><input type='text' name='juros' id='juros' value=></td><td><input type='text' name='multa' id='multa' value=></td>");

    $("#preenche_bol2").html("<td><input type='number' name='op1' value=></td><td><input type='number' name='op2' value=></td><td><input type='number' name='op3' value=></td><td><input type='number' name='op4' value=></td><td><input type='number' name='op5' value=></td><td><input type='number' name='op6' value=></td>");

    $("#info_bol").html("<td><input type='text' name='api' value=></td><td><input type='text' name='token_api' value=></td><td><input type='text' name='sandbox' value=></td><td><input type='text' name='token_sandbox' value=></td>");
    var id;
    ...
    .done(function(data){
       ...
       $("#info_bol").html("<td><input type='text' name='api' value="+API+"></td><td><input type='text' name='token_api' value="+token+"></td><td><input type='text' name='sandbox' value="+sandbox+"></td><td><input type='text' name='token_sandbox' value="+token_sandbox+"></td>");
    });
}
