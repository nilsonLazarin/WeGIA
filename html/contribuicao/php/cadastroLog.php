<?php
    ...
    $query->query("INSERT INTO log_contribuicao(id_socio, ip, data, hora, id_sistema, valor_boleto, data_venc_boleto, id_sociotipo, referencia, status)values('$id_socio', '$ip_log', '$data', '$horahoje', '$sistema', '$valor_doacao', '$data_vencimento', '$tipoSocio', '$referencia', '')");
?>
