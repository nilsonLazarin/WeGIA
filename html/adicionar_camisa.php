...
<head>
	...
	<title>Cadastro de camisa</title>
				...
				<header class="page-header">
					...
					<div class="right-wrapper pull-right">
						<ol class="breadcrumbs">
							...
							<li><span>Cadastro Tamanhos Camisas</span></li>
						</ol>
									...
									<fieldset>
										<form method="post" id="formulario" action="../controle/control.php">
											<div class="form-group"><br>
												<label class="col-md-3 control-label">Camisa</label>
												<div class="col-md-8">
													<input type="text" class="form-control" name="tamanhos" id="tamanhos" required>
												</div>
											</div><br/>
											<input type="hidden" name="nomeClasse" value="CamisaControle">
